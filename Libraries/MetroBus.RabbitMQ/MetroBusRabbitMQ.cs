...
public class MetroBusRabbitMQ : IEventBus, IDisposable
{
    private readonly IRabbitMQPersistentConnection _persistentConnection;
    private readonly IEventBusSubscriptionsManager _subsManager;
    private readonly ILogger<MetroBusRabbitMQ> _logger;
    ...
    public MetroBusRabbitMQ(IRabbitMQPersistentConnection persistentConnection,
        IEventBusSubscriptionsManager subsManager,
        ILogger<MetroBusRabbitMQ> logger,
        ...
        int retryCount = 5)
    {
        ...
        _exchangeName = exchangeName ?? "metrobus";
    ...
    public async Task ProcessEvent(string eventName, string message)
    {
        if (_subsManager.HasSubscriptionsForEvent(eventName))
        {
            ...
            {
                var handler = DIResolver.ServiceProvider.GetService(subscription);
